Generated: docs/ghost-node-reference.org
 Koenig Editor Node Types and Structure
...
Highlighted box with emoji and colored background.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =calloutText=, =calloutEmoji= (default: "💡"), =backgroundColor= (white, grey, blue, green, yellow, red, pink, purple, accent)

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/callout/CalloutNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/callout/callout-renderer.js][Renderer →]]
#+END_CALLOUT

*** toggle

Collapsible accordion. Heading visible, content expands on click.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =heading=, =content=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/toggle/ToggleNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/toggle/toggle-renderer.js][Renderer →]]
#+END_CALLOUT

*** codeblock

Syntax-highlighted code with language and optional caption.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =code=, =language=, =caption=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/codeblock/CodeBlockNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/codeblock/codeblock-renderer.js][Renderer →]]
#+END_CALLOUT
...
Single image with caption, alt, title. Width: regular/wide/full.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =src=, =caption=, =title=, =alt=, =cardWidth= (regular, wide, full), =width=, =height=, =href=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/image/ImageNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/image/image-renderer.js][Renderer →]]
#+END_CALLOUT

*** gallery

Multiple images with automatic layout.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =images= (default: []), =caption=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/gallery/GalleryNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/gallery/gallery-renderer.js][Renderer →]]
#+END_CALLOUT

*** video

Video player with thumbnail. Width: regular/wide/full. Loop option.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =src=, =caption=, =fileName=, =mimeType=, =width=, =height=, =duration= (default: 0), =thumbnailSrc=, =customThumbnailSrc=, =thumbnailWidth=, =thumbnailHeight=, =cardWidth= (regular, wide, full), =loop= (default: false)

*⚠️ Not rendered:* =fileName=, =mimeType=, =duration=, =thumbnailWidth=, =thumbnailHeight=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/video/VideoNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/video/video-renderer.js][Renderer →]]
#+END_CALLOUT

*** audio

Audio player with title and thumbnail.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =duration= (default: 0), =mimeType=, =src=, =title=, =thumbnailSrc=

*⚠️ Not rendered:* =mimeType=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/audio/AudioNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/audio/audio-renderer.js][Renderer →]]
#+END_CALLOUT

*** file

File download card with name, size, caption.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =src=, =fileTitle=, =fileCaption=, =fileName=, =fileSize=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/file/FileNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/file/file-renderer.js][Renderer →]]
#+END_CALLOUT
...
External embed (YouTube, Twitter, etc). Stores URL and embed HTML.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =url=, =embedType=, =html=, =metadata=, =caption=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/embed/EmbedNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/embed/embed-renderer.js][Renderer →]]
#+END_CALLOUT

*** bookmark

Rich link preview with metadata (title, description, thumbnail).

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =title=, =description=, =url=, =caption=, =author=, =publisher=, =icon=, =thumbnail=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/bookmark/BookmarkNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/bookmark/bookmark-renderer.js][Renderer →]]
#+END_CALLOUT

*** html

Raw HTML block. Rendered without processing.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =html=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/html/HtmlNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/html/html-renderer.js][Renderer →]]
#+END_CALLOUT

*** markdown

Markdown content. Converted to HTML on render.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =markdown=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/markdown/MarkdownNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/markdown/markdown-renderer.js][Renderer →]]
#+END_CALLOUT
...
CTA button with text, URL, alignment.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =buttonText=, =alignment= (left, center, right), =buttonUrl=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/button/ButtonNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/button/button-renderer.js][Renderer →]]
#+END_CALLOUT

*** call-to-action

Rich promotional block. Layout: minimal/immersive/branded.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =layout= (minimal, immersive, branded), =alignment= (left, center, right), =textValue=, =showButton= (default: true), =showDividers= (default: true), =buttonText= (default: "Learn more"), =buttonUrl=, =buttonColor= (default: "#000000"), =buttonTextColor= (default: "#ffffff"), =hasSponsorLabel= (default: true), =sponsorLabel= (default: "<p><span style=\"white-space: pre-wrap;\">SPONSORED</span></p>"), =backgroundColor= (white, grey, blue, green, yellow, red, pink, purple, accent), =linkColor= (default: "text"), =imageUrl=, =imageWidth=, =imageHeight=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/call-to-action/CallToActionNode.js][Node →]] 
#+END_CALLOUT

*** signup

Email subscription form. Layout: regular/wide/split.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =alignment= (left, center, right), =backgroundColor= (white, grey, blue, green, yellow, red, pink, purple, accent), =backgroundImageSrc=, =backgroundSize= (default: "cover"), =textColor=, =buttonColor= (default: "accent"), =buttonTextColor= (default: "#FFFFFF"), =buttonText= (default: "Subscribe"), =disclaimer=, =header=, =labels= (default: []), =layout= (regular, wide, split), =subheader=, =successMessage= (default: "Email sent! Check your inbox to complete your signup."), =swapped= (default: false)

*⚠️ Not rendered:* =backgroundSize=, =buttonTextColor=, =buttonText=, =labels=, =successMessage=, =swapped=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/signup/SignupNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/signup/signup-renderer.js][Renderer →]]
#+END_CALLOUT

*** product

Product card with image, rating, buy button.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =productImageSrc=, =productImageWidth=, =productImageHeight=, =productTitle=, =productDescription=, =productRatingEnabled= (default: false), =productStarRating= (default: 5), =productButtonEnabled= (default: false), =productButton=, =productUrl=

*⚠️ Not rendered:* =productImageSrc=, =productImageWidth=, =productImageHeight=, =productTitle=, =productDescription=, =productRatingEnabled=, =productButtonEnabled=, =productButton=, =productUrl=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/product/ProductNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/product/product-renderer.js][Renderer →]]
#+END_CALLOUT
...
Content only shown in email newsletters, hidden on web.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =html=

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/email/EmailNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/email/email-renderer.js][Renderer →]]
#+END_CALLOUT

*** email-cta

Email CTA with member segment targeting.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =alignment= (left, center, right), =buttonText=, =buttonUrl=, =html=, =segment= (default: "status:free"), =showButton= (default: false), =showDividers= (default: true)

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/email-cta/EmailCtaNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/email-cta/email-cta-renderer.js][Renderer →]]
#+END_CALLOUT
...
Transistor.fm podcast player embed.

#+BEGIN_CALLOUT :emoji "📋" :color grey
*Properties:* =accentColor=, =backgroundColor= (white, grey, blue, green, yellow, red, pink, purple, accent)

[[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/transistor/TransistorNode.js][Node →]] [[https://github.com/TryGhost/Koenig/blob/main/packages/kg-default-nodes/lib/nodes/transistor/transistor-renderer.js][Renderer →]]
#+END_CALLOUT
